...
public class PrayerResetPasswordActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    findViewById(R.id.forgot_password_request_button).setOnClickListener(new OnClickListener() {
	...
	private void submitEmail(){
		...
		LostPasswordTask passTask = new LostPasswordTask(getApplicationContext());
		passTask.execute();
	}
